...
<main>
        ...
        <div class="container">
            ...
            <div class="rb-voice-card">
                ...
                <div class="rb-voice-text">
                    ...
                    <p>
                        介護は人と人とが面と向かい合い、直接触れ合って行われる仕事です。疲れることも大変なことも、もちろん沢山あります。しかし、それ以上にお互いの笑顔やありがとうをもっと沢山得られ、とても満足感を感じることができる仕事です。<br>
    ...
    <section class="rb-oneday section bg-cream">
        <div class="container">
            ...
            <div class="oneday-shifts">
                <table class="shift-table">
                    <tbody>
                        <tr>
                            <th>日勤（時差出勤）</th>
                            <td>8:00〜17:00 ／ 8:30〜17:30 ／ 9:00〜18:00<br><span class="note">実働8時間・休憩1時間</span></td>
                        </tr>
                        <tr>
                            <th>夜勤</th>
                            <td>16:00〜翌9:00</td>
            ...
            <div class="oneday-timelines">
                <div class="timeline-card">
                    <h4 class="timeline-title"><i class="fa-solid fa-sun"></i> 日勤スタッフの1日</h4>
                    <ul class="timeline-list">
                        <li><span class="tl-time">8:00</span><span class="tl-task">出勤（時差出勤）／朝食後の服薬介助・口腔ケア</span></li>
                        <li><span class="tl-time">8:30</span><span class="tl-task">体温・バイタルチェック</span></li>
                        <li><span class="tl-time">8:50</span><span class="tl-task">朝礼（夜勤からの申し送り）</span></li>
                        <li><span class="tl-time">9:00</span><span class="tl-task">ラジオ体操／身体介護・生活援助・夢みサービス／レクレーション</span></li>
                        <li><span class="tl-time">11:45</span><span class="tl-task">口腔体操</span></li>
                        <li><span class="tl-time">12:00</span><span class="tl-task">昼食のセッティング・見守り・介助</span></li>
                        <li><span class="tl-time">12:30</span><span class="tl-task">服薬介助・口腔ケア・居室への移動介助<br>交代で休憩（1時間）</span></li>
                        <li><span class="tl-time">15:00</span><span class="tl-task">食堂への誘導・レクレーション</span></li>
                        <li><span class="tl-time">16:45</span><span class="tl-task">口腔体操</span></li>
                        <li><span class="tl-time">17:00</span><span class="tl-task">夕食の見守り・介助</span></li>
                        <li><span class="tl-time">17:30</span><span class="tl-task">服薬介助・口腔ケア・居室への誘導</span></li>
                        <li><span class="tl-time">〜18:00</span><span class="tl-task">退勤（時差退勤）</span></li>
                    </ul>
                </div>
                <div class="timeline-card">
                    <h4 class="timeline-title"><i class="fa-solid fa-moon"></i> 夜勤スタッフの1日</h4>
                    <ul class="timeline-list">
                        <li><span class="tl-time">16:00</span><span class="tl-task">出勤（日勤からの申し送り）</span></li>
                        <li><span class="tl-time">17:00</span><span class="tl-task">夕食の見守り・介助</span></li>
                        <li><span class="tl-time">18:00</span><span class="tl-task">就寝介助</span></li>
                        <li><span class="tl-time">18:00〜</span><span class="tl-task">巡視（2時間おき・起床時まで）・身体介護</span></li>
                        <li><span class="tl-time">20:00</span><span class="tl-task">眠前薬の介助</span></li>
                        <li><span class="tl-time">6:00</span><span class="tl-task">オムツ交換・トイレ介助</span></li>
                        <li><span class="tl-time">7:00</span><span class="tl-task">起床介助</span></li>
                        <li><span class="tl-time">7:30</span><span class="tl-task">朝食の見守り・介助</span></li>
                        <li><span class="tl-time">8:00</span><span class="tl-task">服薬介助・口腔ケア（日勤へ引き継ぎ）</span></li>
                        <li><span class="tl-time">8:50</span><span class="tl-task">朝礼</span></li>
                        <li><span class="tl-time">9:00</span><span class="tl-task">退勤</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="rb-card-grid">
                ...
                <div class="rb-info-card">
                    ...
                    <h4>資格取得支援</h4>
                    <p>介護福祉士などの資格取得にかかる費用を会社が全額負担します。</p>
                </div>
            </div>
        </div>
    </section>
