...
<main>
    ...
    <section class="page-header" style="height: 300px;">
        ...
        <div class="container text-center" style="z-index: 1;">
            <h2 class="page-title">夢み寮 だいもつ<span class="ja">Daimotsu Facility</span></h2>
        </div>
    </section>
    ...
    <section class="facility-gallery section">
        <div class="container container-narrow">
            ...
            <div class="gallery-grid mt-4">
                ...
                <div class="gallery-item">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/daimotsu2.jpg"
                ...
                <div class="gallery-item">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/daimotsu4.jpg"
