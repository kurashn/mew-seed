...
<main>
    ...
    <section class="page-header" style="height: 300px;">
        ...
        <div class="container text-center" style="z-index: 1;">
            <h1 class="page-title"><span class="nobr">住宅型有料老人ホーム</span> <span class="nobr">夢み寮 だいもつ</span><span class="ja">Daimotsu Facility</span></h1>
        </div>
    </section>
    ...
    <section class="facility-intro section">
        <div class="container">
            <div class="intro-content text-center">
                <h3 class="facility-catchphrase"><span class="nobr">阪神電車『大物駅』より</span><span class="nobr">徒歩1分。</span><br><span class="nobr">令和7年4月、</span><span class="nobr">新しい夢み寮が</span><span class="nobr">オープンしました。</span></h3>
                <p class="mt-4">
    ...
    <section class="facility-access section">
        <div class="container container-narrow">
            ...
            <div class="map-wrapper mt-4">
                ...
                <iframe
                    src="https://maps.google.com/maps?q=34.717518,135.426849&z=17&hl=ja&output=embed"
